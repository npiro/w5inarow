...
source code contact the author (Nicolas Piro) at nnp@hp1.uib.es
...
*Minor tunning on the engine.
*Cleaned up the code.  
What's new in version 1.5:
*Incredible speed optimization: version 1.5 is 400% faster that 1.4 reaching speeds of
42000 nps on a 19x19 board in my PII@233 where the old versions reached 13000 nps. This is
due to a great improvement on the search algorithm that speeds things up considerably.
